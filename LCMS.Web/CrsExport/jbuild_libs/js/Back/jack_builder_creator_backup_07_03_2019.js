...
{
	//alert("lesson_name: " + lesson_name);
	
	
	
	//alert("TOC.length:" + TOC.length);
pgQueArray = [];	
...
if(typeof courseType !== "undefined")
	...
	//choice: allPgQue[np_num-1][q_ct].choice || 0,
...
//$("#card1").flip({
	...
	$('#swiffy_file').load("corporations.html");
...
function close_keyterm() {
  ...
  document.getElementById("jb_modal_main_text").innerHTML = "";	
	...
	//alert("Close Baby Yeah!");
document.getElementById('flip_10').style.pointerEvents = 'auto';	
	//alert(document.getElementById("flip_10"));	
	
	//disabled=true
	
	//document.getElementById("flip_10").disabled = false;
	
	//document.getElementById("flip_10").onclick = true;
...
//-------------------------------------------------------------------------------------------------------------													
										...
										case "Swiffy":
											...
											swiffy_data = sSelections[jcc][snglBld[jcc]];
											
											//alert(swiffy_data[0].Title);
											//swiffy_name
											
						Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='col-lg-12 col-md-12 col-xs-12' align='center'>";
						Jcc_Comp_Maker = Jcc_Comp_Maker + "<p>"+swiffy_data[0].Title+"<\p>";
						
						Jcc_Comp_Maker = Jcc_Comp_Maker + "<div id='swiffy_file'></div>";	//style='width: 100%; height: 100%;'				
						
											
						//$('#swiffy_file').load("corporations.html");					
											
						//document.getElementById("swiffy_file").innerHTML='<object type="text/html" data="corporations.html" ></object>';					
						
						//alert("/json/corporations.html");					
						/*
						$.get('json/corporations.html')
 							.success(function(data) {
     													$('div.content').html(data);
 													});					
											
						*/					
						//$('#swiffy_file').load('/json/corporations.html');

											
						//json/361TTTT_Number _1.js					
						//Jcc_Comp_Maker = Jcc_Comp_Maker + "<div id='swiffycontainer' style='width: 100%; height: 100%;'></div>";					
											
											
						//Jcc_Comp_Maker = Jcc_Comp_Maker + "";					
											
						Jcc_Comp_Maker = Jcc_Comp_Maker + "<\div>";					
		//var swfy = "json/corporations.js";
			//<script src="json/corporations.js"></script>	
		//swfy = new swiffy.Stage(document.getElementById('swiffycontainer'),									
...
/*											
  ...
  <body style="margin: 0; overflow: hidden">
    <!--<div id="swiffycontainer" style="width: 551px; height: 402px">-->
...
case "Flip_Multi_New": //Flip_Multi											
									...
									//alert(flip_card_data[0].top_margin);	
									//alert(flip_card_data[0].top_margin);	
									//alert(flip_card_data[0].flip_box_height);	
//<div id="card" class="card outerBody">
											
//Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='jb_char_para' align='center'>";												
	
											
//style='height:"+flip_card_data[0].flip_box_height+"'											
							
	//alert(flip_card_data.length);										
...
//-------------------------------------------------------------------------------------------------------------												
			...
			//alert("Question number: " + allPgQue[np_num][Q_count].question + " Choice: " + allPgQue[np_num][Q_count].choice + " jcc: " + jcc);
									...
									//alert( "True_False: " + qComp[4].question_answers[qAns].true_false );		
											
											
					//Q_Recall[allPgQue[np_num][Q_count].question] = ("cb_" + jcc + "_" + allPgQue[np_num][Q_count].choice); 
					Q_Recall[jcc] = ("cb_" + jcc + "_" + allPgQue[np_num][Q_count].choice);
					Q_Choice[jcc] = (allPgQue[np_num][Q_count].choice);						
											
											//alert(Q_Recall[allPgQue[np_num][Q_count].question]);
											//alert("jcc: " + jcc);
											//alert("Q_Recall["+jcc+"]: " + Q_Recall[jcc]);
					...
					for(var queList = 1; queList < qComp[2].qList.length; queList++)	
							{
								//alert("list text: " + qComp[2].qList[queList].lstText);
									//qpara_text //<jb1>
// Removed jb1 as the style of the list and it works in IE: 4/25/2019	jb_column1							
Jcc_qText_Mover[jcc] = Jcc_qText_Mover[jcc] + "<jb1><li class='jb_column1' style='margin-left:40px; text-align: "+ qComp[2].qList[0].align_text +";'>"+ qComp[2].qList[queList].lstText +"</li></jb1>"; //</jb1>
...
//border-top: thin; border-top-color: #000000; border-top-style:solid; border-top-width: thin; 
	...
	//alert("Current number of answers for comp " + jcc + " : " + qComp[4].question_answers.length);										
...
Q_Square = [];
				...
				for(var qSquare = 0; qSquare < qComp[4].question_answers.length; qSquare++)
					{
						//alert(qComp[4].question_answers[qSquare].true_false);
						
						if(qComp[4].question_answers[qSquare].true_false === "true")
							{
								Q_Square[jcc] = qComp[4].question_answers[qSquare].true_false;
								
								//alert("Q_Square["+jcc+"]: " + Q_Square[jcc]);
							}
						
						
						
						
						//Q_Square[qSquare] = qComp[4].question_answers[qAns].true_false;
						
						//alert(qComp[4].question_answers[qAns].true_false);
						
						
						
						//Q_Square = (qComp[4].question_answers.length);	
					}
*/					
			}
...
/*
q_feedback_array === Speech_Bub_Array
		...
		if(typeof q_feedback_array[qAns] !== "undefined")
			{
				...
				//alert("******* q_feedback_qNum_Array[jcc][qAns]: " + q_feedback_qNum_Array[jcc][qAns] + " *******");
			}
...
if(typeof Q_Recall[jcc] != "undefined")
					{
						...
						//alert("Q_Choice["+jcc+"]: " + Q_Choice[jcc]);
						
						//alert("Q_Choice["+jcc+"]: " + Q_Choice[jcc] + " : " + qComp[4].question_answers[qAns].true_false );
...
/*						
						if(Q_Choice[jcc] === qAns)
							{
								...
								if(qComp[4].question_answers[qAns].true_false === "true")
									{
										////alert("Q_Choice["+jcc+"]: " + Q_Choice[jcc] + " : " + qComp[4].question_answers[qAns].true_false );
		//Jcc_Comp_Maker = Jcc_Comp_Maker + "<label class='container' style='font-weight: normal !important; text-align:"+qComp[2].qList[0].align_text+"'><jb1 id='qs_"+jcc+"_an_"+qAns+"' class='qtext ma_CorrectNS'>"+qComp[4].question_answers[qAns].q_answer+"</jb1>";										
									}
		...
		//Jcc_Comp_Maker = Jcc_Comp_Maker + "<label class='container' style='font-weight: normal !important; text-align:"+qComp[2].qList[0].align_text+"'><jb1 id='qs_"+jcc+"_an_"+qAns+"' class='qtext'>"+qComp[4].question_answers[qAns].q_answer+"</jb1>";
								...
								//alert("Q_Choice[jcc]= " + Q_Choice[jcc] + " : qAns = " + qAns )
							}
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='carousel_margin jb_mx_wd'><div id='"+jcc + "_" +"jcCarousel' class='carousel slide' data-ride='false' data-interval='false' data-wrap='"+jcc_car_data[0].repeat+"' style='background-color:"+jcc_car_data[0].back_color+"; margin-top:"+jcc_car_data[0].top_margin+"'>";	
// Carousel indicators
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='jb_char_para' id='audio_trans_" + jcc +"' style='display: none; margin-top:10px; border: medium; border-style: solid; border-color: #000000;height:300px; overflow-y: auto; overflow-x: hidden ;padding:5px;'>";
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='col-lg-12 col-md-12 col-xs-12' style=' background-color:"+sSelections[jcc][snglBld[jcc]][5].background_color+"; margin-top:" + sSelections[jcc][snglBld[jcc]][4].top_margin+";padding: "+ sSelections[jcc][snglBld[jcc]][6].padding +";'>";
...
//-------<(  Heading )>-------											
Jcc_Comp_Maker = Jcc_Comp_Maker + "<"+sSelections[jcc][snglBld[jcc]][0].heading_size+" class='quest_char' style='border-bottom-style: "+sSelections[jcc][snglBld[jcc]][0].heading_underline+"; border-bottom-color:"+sSelections[jcc][snglBld[jcc]][0].heading_underline_color+" ;border-bottom-width: "+sSelections[jcc][snglBld[jcc]][0].heading_underline_height+"; color:"+sSelections[jcc][snglBld[jcc]][0].heading_color+"; font-style: "+sSelections[jcc][snglBld[jcc]][0].heading_style+"; text-align: "+ sSelections[jcc][snglBld[jcc]][0].heading_alignment +"'>"+ sSelections[jcc][snglBld[jcc]][0].List_Heading +"</"+sSelections[jcc][snglBld[jcc]][0].heading_size+">";
//-------<(  Heading )>-------											
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<li class='quest_char' style='margin-left:40px; color:"+ sSelections[jcc][snglBld[jcc]][7].text_color +"; text-align: "+ sSelections[jcc][snglBld[jcc]][2].align_text +";'><"+sSelections[jcc][snglBld[jcc]][3].List_Text_Size+">"+ List_Text_Array[lst] +"</"+sSelections[jcc][snglBld[jcc]][3].List_Text_Size+"></li>";																	
...
/*
//-------------------------------------------------------------------------------------------------------------	
//-------<( Paragraph New code begin )>-------	SA	current									
//-------------------------------------------------------------------------------------------------------------					
					case "Paragraphs_New": // SA  img_loc = "images/";
								var paraSetup = sSelections[jcc][snglBld[jcc]][0];	
	Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='jb_char_para' align='center'>";							
	...
	Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='col-lg-12 col-md-12 col-xs-12' style='width:100%; height:auto; padding: 0px 20px; background-color:"+paraSetup.background_color+";border-color:"+paraSetup.border_color+"; border-width:"+paraSetup.border_weight+"; border-style:"+paraSetup.border_style+"; border-radius:"+paraSetup.border_radius+"; margin-top:"+paraSetup.top_margin+";'>";					
					}
										
		Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='padding:"+paraSetup.Padding+";'><span class='jb_char_para' style='text-align:"+paraSetup.heading_alignment+"; color:"+paraSetup.heading_color+"'>";
		...
		for(var newpara = 1; newpara < sSelections[jcc][snglBld[jcc]].length; newpara++)
						...
						switch(paraSetup.columns)
							{
								case "1":
Jcc_Comp_Maker = Jcc_Comp_Maker + "<p class='jb_column1 jb_char_para' style='color:"+paraSetup.Paragraph_Font_color+"; text-align:"+paraSetup.Paragraph_align+";line-height:"+paraSetup.line_spacing+"'><"+paraSetup.Paragraph_Font_Size+">"+ sSelections[jcc][snglBld[jcc]][newpara].Paragraph_txt +"</"+paraSetup.Paragraph_Font_Size+"></p>";	
									
								break;	
									
								case "2":
Jcc_Comp_Maker = Jcc_Comp_Maker + "<p class='jb_column2 jb_char_para' style='color:"+paraSetup.Paragraph_Font_color+"; text-align:"+paraSetup.Paragraph_align+";line-height:"+paraSetup.line_spacing+"'><"+paraSetup.Paragraph_Font_Size+">"+ sSelections[jcc][snglBld[jcc]][newpara].Paragraph_txt +"</"+paraSetup.Paragraph_Font_Size+"></p>";									
								break;	
							}
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='margin-top: "+sSelections[jcc][snglBld[jcc]][0].top_margin+"; border-style:"+acc_ck.Border_Style+"; border-color:"+acc_ck.Border_Color+"; border-width:"+acc_ck.Border_Thickness+"; border-radius:"+acc_ck.Border_Radius+"; ' class='panel-group jb_mx_wd' id='jb_accordion_" + jcc + "'>";
...
if(typeof courseType !== "undefined")
	...
	if(courseType.indexOf("shortcourseA") !== -1 && courseType.indexOf("demo") === -1)
		{
			//alert("curQnum: " + curQnum);
			//alert(typeof courseType);			
			...
			//alert(allPgQue[np_num].length);
			//np_num
			
			
			//alert(pgQueArray.length);
			//Object.keys(LDF[0][jcc_test[ln_num]]);
			
			////allPgQue[np_num] = pgQueArray[curQnum];
			//alert(allPgQue.length);
			...
			//if(q_feedback_array[qest].length > 0) 
				{
					...
					//alert("q_feedback_qNum_Array["+curComp+"]["+qest+"]: " +  q_feedback_qNum_Array[curComp][qest] );
...
*/							
			...
			if(q_feedback_qNum_Array[curComp].length > 0 )
				{
					//document.getElementById("cor_idfeedback_" + curComp).innerHTML = q_feedback_qNum_Array[curComp][qest]; "Answer " + (qest + 1) + ": " +
