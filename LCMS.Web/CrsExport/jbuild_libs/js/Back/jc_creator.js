...
//-------------------------------------------------------------------------------------------------------------
										...
										case "Lesson_Table_of_Contents":
											
											toc_names = sSelections[jcc][snglBld[jcc]];
											// style='text-align: center'
											
											Jcc_Comp_Maker = Jcc_Comp_Maker + "<div><ul id='buttons' class='list-unstyled main-menu' style='list-style-type:none; font-size:20px;'><jcc_list_title id='menu_selection'></jcc_list_title>";
											
											
												for(var toc = 0; toc < toc_names.length; toc++)
														{
Jcc_Comp_Maker = Jcc_Comp_Maker + "<li onClick='javascript:Lesson_Selection("+toc+")'>"+sSelections[jcc][snglBld[jcc]][toc].lesson_name+"</li>";

//$("#Table_o_Contents ul").append("<div onClick='javascript:Page_Selection(" + tbl + ")' id='toc_' + tbl><li><l3>" + toc_Array[tbl] + "</l3></li></div>");
																		
															//alert(sSelections[jcc][snglBld[jcc]][toc].page_name);
														}
...
<div style="margin-top: 100px">
	<ul id='buttons' class='list-unstyled main-menu' style='list-style-type:none; font-size:20px;'><jcc_list_title id="menu_selection"></jcc_list_title>
		<li>One</li>
		<li>Two</li>
		<li>Three</li>
		<li>Four</li>
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='col-lg-12 col-md-12 col-xs-12>";	//class='col-lg-12 col-md-12 col-xs-12'  Look into 										
...
for(var qAns = 0; qAns < qComp[4].question_answers.length; qAns++)
	...
	//alert(qComp[0].feedback_align);	true_false									
		...
		Jcc_Comp_Maker = Jcc_Comp_Maker + "<div id='c_fb_"+jcc+"' style='display:none; text-align:"+qComp[0].feedback_align+"' class='ma_FB_Correct'><"+qComp[0].question_size+"><"+qComp[5].correct_incorrect_font_size+">"+qComp[5].correct_feedback+"</"+qComp[5].correct_incorrect_font_size+"></"+qComp[0].question_size+"><div><p>"+qComp[5].Additional_feedback+"</p></div></div>";									
										
		Jcc_Comp_Maker = Jcc_Comp_Maker + "<div id='i_fb_"+jcc+"' style='display:none; text-align:"+qComp[0].feedback_align+"' class='ma_FB_Incorrect'><"+qComp[0].question_size+"><"+qComp[5].correct_incorrect_font_size+" style='color:#85be00'>"+qComp[5].incorrect_feedback+"</"+qComp[5].correct_incorrect_font_size+"></"+qComp[0].question_size+"><div><p>"+qComp[5].Additional_feedback+"</p></div></div>";											
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='border-top: thin; border-top-color: #000000; border-top-style:solid; border-top-width: thin'><a style='margin-top:10px' href='javascript:Question_Comp_Submit("+jcc+");' class='btn btn-primary disabled' id='sub_"+jcc+"'>Submit</a></div>";
}											
...
/*											
//-------------------------------------------------------------------------------------------------------------	
//-------<( Question Multiple Answer code end )>-------		 jcCarousel_Two									
//-------------------------------------------------------------------------------------------------------------										
									case "Carousel_2":
								var jcc_car2_data = sSelections[jcc].Carousel_2;
											
								//list_items
											
											//alert(jcc_car2_data.length);
											//alert(jcc_car2_data[1].Slide.list_items.length);
								var lst_car = jcc_car2_data[1].Slide.list_items;
											
								for(var crtwo = 0; crtwo < jcc_car2_data[1].Slide.list_items.length; crtwo++)
									{
										//alert(crtwo);
										lst_car_Array[crtwo] = lst_car[crtwo].lstText;
										alert(lst_car_Array[crtwo]);
									}
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='col-lg-12 col-md-12 col-xs-12'>";											
//-------------------------------------------------------------------------------------											
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='carousel_margin'><div id='"+jcc + "_" +"jcCarousel_Two' class='carousel slide' data-ride='false' data-interval='false' style='background-color:"+jcc_car2_data[0].back_color+"; margin-top:"+jcc_car2_data[0].top_margin+"'>";											
// Carousel indicators
										
Jcc_Comp_Maker = Jcc_Comp_Maker + "<ol class='carousel-indicators' style='bottom: -10px; margin-bottom:10px;'>"; //margin-bottom:10px;
			var car2_count;								
				for(var jcc_car2_ind = 1; jcc_car2_ind < jcc_car2_data.length; jcc_car2_ind++)
							{
								if(jcc_car2_ind === 1)
									{
										car2_count = (jcc_car2_ind - 1);  //  href='#"+jcc + "_" +"jcCarousel'
										
			                            Jcc_Comp_Maker = Jcc_Comp_Maker + "<li data-target='#"+jcc + "_" +"jcCarousel_Two' data-slide-to='"+(Number(car2_count))+"' class='active'></li>"; 
									}
										else
									{
										car2_count = (jcc_car2_ind - 1);
			                            Jcc_Comp_Maker = Jcc_Comp_Maker + "<li data-target='#"+jcc + "_" +"jcCarousel_Two' data-slide-to='"+(Number(car2_count)) +"'></li>";
									}
...
for(var jcc_car2 = 1; jcc_car2 < jcc_car2_data.length; jcc_car2++)
	{
			if(jcc_car2 === 1) // <img src="../Mod_01/images/boom.jpg" alt="First Slide">
				{
				  Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='padding-left:"+jcc_car2_data[jcc_car2].Slide.Padding+";padding-right:"+jcc_car2_data[jcc_car2].Slide.Padding+"' class='item active'>";

					if(jcc_car2_data[jcc_car2].Slide.Image.length > 0)
						{ // jcc_car_data[jcc_car].Slide.Image_Placement
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='text-align:"+jcc_car2_data[jcc_car2].Slide.Image_Placement+"'><img style='margin-top:"+jcc_car2_data[0].slide_top_margin+"; width:"+jcc_car2_data[jcc_car2].Slide.image_size+"' src='"+img_loc+""+jcc_car2_data[jcc_car2].Slide.Image+"' x alt='"+jcc_car2.toString()+"'></div>";
						}
					
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='width: 75%; background-color:"+jcc_car2_data[1].Slide.background_color+"; padding:"+jcc_car2_data[jcc_car2].Slide.Padding+"; text-align:"+jcc_car2_data[0].Text_align+"; color:"+jcc_car2_data[1].Slide.Text_Color+";'><"+jcc_car2_data[jcc_car2].Slide.Text_Font_Size+">"+jcc_car2_data[jcc_car2].Slide.Text+"</"+jcc_car2_data[jcc_car2].Slide.Text_Font_Size+"></div>";		
			...
			if(jcc_car2 > 1)
				{
				  Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='padding-left:"+jcc_car2_data[jcc_car2].Slide.Padding+";padding-right:"+jcc_car2_data[jcc_car2].Slide.Padding+"' class='item'>";
...
//Carousel controls -->
Jcc_Comp_Maker = Jcc_Comp_Maker + "<a class='carousel-control left' style='left: 0%' href='#"+jcc + "_" +"jcCarousel_Two' data-slide='prev'>";
Jcc_Comp_Maker = Jcc_Comp_Maker + "<span class='glyphicon glyphicon-chevron-left'></span>";
Jcc_Comp_Maker = Jcc_Comp_Maker + "</a>";
Jcc_Comp_Maker = Jcc_Comp_Maker + "<a class='carousel-control right' href='#"+jcc + "_" +"jcCarousel_Two' data-slide='next'>";
...
//-------------------------------------------------------------------------------------------------------------										//	heading_size -- sSelections[jcc][snglBld[jcc]][0].heading_size
			...
			//	Heading_Text_Size -- 
										...
										case "List_text_paragraph": // SA
											...
											//alert(sSelections[jcc][snglBld[jcc]][4].top_margin);
...
//-------------------------------------------------------------------------------------------------------------												
									case "Heading":	
									//alert(sSelections[jcc][snglBld[jcc]][2].top_margin);
...
switch(qtyp)
	...
	case 2:
			...
			//alert(Question_Type_Array[curComp]);
			//curComp
		...
		for(var two_test = 0; two_test < QC_Multi_Array_TF[cqest].length; two_test++)	
			{
				...
				cb_chk_Array[two_test] = (document.getElementById(cb_cmp_array[two_test]).checked.toString());
				 	...
				 	//alert(QC_Multi_Array_TF[cqest][two_test].toString()); // Answer Key
					//alert("cb_chk_Array[two_test] " + cb_chk_Array[two_test]);
				//alert(document.getElementById(cb_cmp_array[two_test]).checked.toString());
...
//╚═════════════════════════════════════════════════════════════════════════════════════════════════╝
	...
	function Lesson_Selection(btnNum)
	{
		...
		//alert("Lesson_Selection called button number " + btnNum + " was called.");
		
		btnNum = (btnNum + 1);
		
		//alert(Course_Number_Val + "_M" + Module_Number_Val + "_L" + btnNum + ".html");
...
{
	//alert("next_lesson called");
	//alert(window.location.pathname.length);
	
	
	//alert(window.location.pathname.charAt(window.location.pathname.length - 6));
	
	////toc_names = sSelections[jcc][snglBld[jcc]];
	
	
	////alert(toc_names.length);
