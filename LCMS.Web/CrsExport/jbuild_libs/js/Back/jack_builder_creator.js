...
//Jcc_Comp_Maker = Jcc_Comp_Maker + "<table id='table_new"+jcc+"' style='width:"+new_jcc_tbl_whole[2].Whole_Table_Settings[0].Table_Width+";  border-collapse: collapse; padding:10px; text-align:center'>";											
			...
			if(Image_Multi[im_ttl].image_file_tag.length > 125)
				{
					...
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<img style='width:"+Image_Multi[im_ttl].image_width+"; margin-top: "+Image_Multi[im_ttl].image_top_margin+"; border-style: "+Image_Multi[im_ttl].image_border_style+"; border-color: "+Image_Multi[im_ttl].image_border_color+"; border-width: "+Image_Multi[im_ttl].image_border_width+"; border-radius: "+Image_Multi[im_ttl].image_border_radius+"' src='"+img_loc+"" + Image_Multi[im_ttl].image_file + "' alt='Select image for more information' role='button' onclick='alt_tag_lib("+ma_alt+")'>";  //im_ttl  ma_alt
			...
			if(typeof jcc_car_data[jcc_car].Slide.Image_tag === "undefined")
				{
					...
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='text-align:"+jcc_car_data[jcc_car].Slide.Image_Placement+"'><img style='margin-top:"+jcc_car_data[0].slide_top_margin+"; width:"+jcc_car_data[jcc_car].Slide.image_size+"' src='"+img_loc+""+jcc_car_data[jcc_car].Slide.Image+"' x alt=''><div><img alt='Select to enlarge image' src='"+mag_lens+"' onClick='javascript:imgZoom("+jcc+","+jcc_car+")' style='margin-top:8px'></div>";
			...
			if(typeof jcc_car_data[jcc_car].Slide.Image_tag === "undefined")
				{
					...
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='text-align:"+jcc_car_data[jcc_car].Slide.Image_Placement+"'><img style='margin-top:"+jcc_car_data[0].slide_top_margin+"; width:"+jcc_car_data[jcc_car].Slide.image_size+"' src='"+img_loc+""+jcc_car_data[jcc_car].Slide.Image+"' x alt=''><div><img alt='Select to enlarge image' src='"+mag_lens+"' onClick='javascript:imgZoom("+jcc+","+jcc_car+")' style='margin-top:8px'></div></div>";	
				}					
			...
			if(typeof jcc_car_data[jcc_car].Slide.Image_tag !== "undefined")
				{
					...
					if(jcc_car_data[jcc_car].Slide.Image_tag.length <= 125)
						{						
							...
							Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='text-align:"+jcc_car_data[jcc_car].Slide.Image_Placement+"'><img style='margin-top:"+jcc_car_data[0].slide_top_margin+"; width:"+jcc_car_data[jcc_car].Slide.image_size+"' src='"+img_loc+""+jcc_car_data[jcc_car].Slide.Image+"' x alt='"+jcc_car_data[jcc_car].Slide.Image_tag+"'><div><img alt='Select to enlarge image' src='"+mag_lens+"' onClick='javascript:imgZoom("+jcc+","+jcc_car+")' style='margin-top:8px'></div></div>";
						}	
					...
					if(jcc_car_data[jcc_car].Slide.Image_tag.length > 125)
						{
							...
							Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='text-align:"+jcc_car_data[jcc_car].Slide.Image_Placement+"'><img style='margin-top:"+jcc_car_data[0].slide_top_margin+"; width:"+jcc_car_data[jcc_car].Slide.image_size+"' src='"+img_loc+""+jcc_car_data[jcc_car].Slide.Image+"' x alt='Select image for more information'  role='button' onclick='alt_tag_lib("+jcc_car+")'><div><img alt='Select to enlarge image' src='"+mag_lens+"' onClick='javascript:imgZoom("+jcc+","+jcc_car+")' style='margin-top:8px'></div></div>";
						}						
				...
				for(var itl_list = 0; itl_list < sSelections[jcc][snglBld[jcc]][3][iwt_whole_array[3][1]].length; itl_list++)
					{
						...
						Img_List_Maker = Img_List_Maker + "<li style='margin-left:40px;'><"+sSelections[jcc][snglBld[jcc]][5][iwt_whole_array[5][1]]+">"+sSelections[jcc][snglBld[jcc]][3][iwt_whole_array[3][1]][itl_list].img_lstText+"</"+sSelections[jcc][snglBld[jcc]][5][iwt_whole_array[5][1]]+"></li>";
...
function iwt_text()
		{
					...
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='font-style:"+sSelections[jcc][snglBld[jcc]][4][iwt_whole_array[4][1]]+";font-variant:"+sSelections[jcc][snglBld[jcc]][4][iwt_whole_array[4][2]]+";font-weight:"+sSelections[jcc][snglBld[jcc]][4][iwt_whole_array[4][3]]+"; color:"+sSelections[jcc][snglBld[jcc]][4][iwt_whole_array[4][0]]+";text-align: "+ sSelections[jcc][snglBld[jcc]][5][iwt_whole_array[5][0]] +";'><"+sSelections[jcc][snglBld[jcc]][5][iwt_whole_array[5][1]]+">" + sSelections[jcc][snglBld[jcc]][3][iwt_whole_array[3][0]] + "</"+sSelections[jcc][snglBld[jcc]][5][iwt_whole_array[5][1]]+"></div>";
...
//-------------------------------------------------------------------------------------------------------------				
			...
			//alert("jcc_data[3].image_list: " + jcc_data[3].image_list);
				
			
					//alert(jcc_data[3].list_border_height);
					//alert(jcc_data[3].list_border_color);
			
					//alert(jcc_data[4].image_text_top_margin);
				
		function ac_text(actc)
				{
					//border-style:"+jcc_data[3].list_border_style+";border-width:"jcc_data[3].list_border_height";border-color:"+jcc_data[3].list_border_color+";
...
//jcc_data[3].image_text_below_top_margin
		...
		function ac_list()
				...
				//alert(jcc_data[3].image_text);


					/*
					alert(jcc_data[3].image_list.length);
					alert(jcc_data[3].list_position);
					alert(jcc_data[3].top_margin);
					alert(jcc_data[3].Type_of_List);
					alert(jcc_data[3].ul_type);
					alert(jcc_data[3].ol_type);
					alert(jcc_data[3].List_Text_Size);
					alert(jcc_data[3].list_border_style);
					alert(jcc_data[3].list_border_height);
					alert(jcc_data[3].list_border_color);
					alert(jcc_data[3].image_text_below);
					alert(jcc_data[3].image_text_below_top_margin);

					
					alert(jcc_data[6].snippet_top_margin);
					*/
				...
				switch(jcc_data[1].image_position)
					{
						case "left":
							...
							if(jcc_data[0].image_w_text_tag.length <= 125)
								{
									jb_Acc_Con = jb_Acc_Con + "<img style='border-style:"+jcc_data[0].border_style+"; border-width:"+jcc_data[0].border_height+"; border-color:"+jcc_data[0].border_color+"; border-radius:"+ jcc_data[8].image_radius +"' src='"+img_loc+"" + jcc_data[0].image_name + "' width=' " + jcc_data[2].image_size + " ' height='auto' alt='"+jcc_data[0].image_w_text_tag+"'>";
								}
							if(jcc_data[0].image_w_text_tag.length > 125)
								{
									
									img_lst_ada = ("" + jcc + acc_Count);
									jb_Acc_Con = jb_Acc_Con + "<img style='border-style:"+jcc_data[0].border_style+"; border-width:"+jcc_data[0].border_height+"; border-color:"+jcc_data[0].border_color+"; border-radius:"+ jcc_data[8].image_radius +"' src='"+img_loc+"" + jcc_data[0].image_name + "' width=' " + jcc_data[2].image_size + " ' height='auto' alt='Select image for more information' role='button' onclick='alt_tag_lib("+img_lst_ada+")'>";
