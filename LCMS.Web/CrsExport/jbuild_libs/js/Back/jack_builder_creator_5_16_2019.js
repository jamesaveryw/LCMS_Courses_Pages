...
for(var qAns = 0; qAns < qComp[4].question_answers.length; qAns++)
	{
		...
		if(typeof q_feedback_array[qAns] !== "undefined")
			{
				...
				//alert(q_feedback_qNum_Array[jcc]);
			}
		...
		//q_feedback_qNum_Array[jcc] = qComp[4].question_answers[qAns].q_feedback;
		
		//alert(q_feedback_qNum_Array[jcc]);	
		//alert("q_feedback_array["+qAns+"]: " + q_feedback_array[qAns]);
	...
	if(cqtn === true)
		{
			...
			//alert(q_feedback_qNum_Array[curComp].length);
			
			if(q_feedback_qNum_Array[curComp].length > 0)
			//if(q_feedback_array[qest].length > 0) 
				{
					//alert(q_feedback_qNum_Array[curComp][qest]);
...
{
	//alert(jbsrc + " : jb_src has been called");
	
	
	//alert(source_Array[jbsrc]);
