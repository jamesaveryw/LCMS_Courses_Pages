...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='col-lg-12 col-md-12 col-xs-12' style='height: 100%; background-color:"+Image_Multi[0].main_background_color+"; padding-bottom: 10px;;'>";												
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='col-lg-12 col-md-12 col-xs-12' style='height: 100%; background-color:"+Flip_Multi_data[0].main_background_color+"; padding-bottom: 10px;'>";
...
/*					
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='flip'>";	//flip card start
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='card front alert alert-info'>";
//Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='front alert alert-info' style='width:100%; height:auto'>"; // front card	begin
//flip_container					
Jcc_Comp_Maker = Jcc_Comp_Maker + "<img  src='"+img_loc+"" + Flip_Multi_data[flp_ttl].Front_Image + "' alt='' style='width: 100%' />";
Jcc_Comp_Maker = Jcc_Comp_Maker + "<p><jb1>"+Flip_Multi_data[flp_ttl].Front_Text+"</jb1></p>";
Jcc_Comp_Maker = Jcc_Comp_Maker + "</div> "; // front card	end		
					
					
Jcc_Comp_Maker = Jcc_Comp_Maker + "</div>"; //flip card end					
*/					
					
					
//<div class="w3-card-4 w3-margin" style="width:50%">					
//style='height: "+Flip_Multi_data[flp_ttl].Card_height+";'					
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='flip'>";	//flip card start
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='front alert alert-info flip_container card' style='width:100%; height:auto'>"; // front card	begin

//Jcc_Comp_Maker = Jcc_Comp_Maker + "<div>";

//Jcc_Comp_Maker = Jcc_Comp_Maker + "<img style='width: "+Flip_Multi_data[flp_ttl].Front_Image_width+"' src='"+img_loc+"" + Flip_Multi_data[flp_ttl].Front_Image + "' alt='' />";					
					
Jcc_Comp_Maker = Jcc_Comp_Maker + "<p style='text-align:"+Flip_Multi_data[flp_ttl].Front_Text_alignment+"'><"+Flip_Multi_data[flp_ttl].Front_Text_Size+">"+Flip_Multi_data[flp_ttl].Front_Text+"</"+Flip_Multi_data[flp_ttl].Front_Text_Size+"></p>";					
					
//Jcc_Comp_Maker = Jcc_Comp_Maker + "</div>";
				
Jcc_Comp_Maker = Jcc_Comp_Maker + "</div> "; // front card	end
				
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='back card alert alert-info' style='width:100%; height:auto'>"; // back card	begin	
Jcc_Comp_Maker = Jcc_Comp_Maker + "<img style='width: "+Flip_Multi_data[flp_ttl].Back_Image_width+"' src='"+img_loc+"" + Flip_Multi_data[flp_ttl].Back_Image + "' alt='' />";
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div><p style='text-align:"+Flip_Multi_data[flp_ttl].Back_Text_alignment+"'><"+Flip_Multi_data[flp_ttl].Back_Text_Size+">"+Flip_Multi_data[flp_ttl].Back_Text+"</"+Flip_Multi_data[flp_ttl].Back_Text_Size+"></p></div>";											
Jcc_Comp_Maker = Jcc_Comp_Maker + "</div> "; // back card	begin
...
for(var qAns = 0; qAns < qComp[4].question_answers.length; qAns++)
	...
	//style='vertical-align: baseline;'
		...
		Jcc_Comp_Maker = Jcc_Comp_Maker + "<label class='container' style='text-align:"+qComp[2].qList[0].align_text+"'><jb1 class='qtext'>"+qComp[4].question_answers[qAns].q_answer+"</jb1>";
		Jcc_Comp_Maker = Jcc_Comp_Maker + "<input style='cursor:pointer;' onclick='nQue();' type='checkbox'>";
		Jcc_Comp_Maker = Jcc_Comp_Maker + "<span class='checkmark'></span>";
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='border-top: thin; border-top-color: #000000; border-top-style:solid; border-top-width: thin'><a style='margin-top:10px' href='#' class='btn btn-primary'>Submit</a></div>";
Jcc_Comp_Maker = Jcc_Comp_Maker + "";											
Jcc_Comp_Maker = Jcc_Comp_Maker + "";
Jcc_Comp_Maker = Jcc_Comp_Maker + "";
Jcc_Comp_Maker = Jcc_Comp_Maker + "";
			...
			if(jcc_car === 1) // <img src="../Mod_01/images/boom.jpg" alt="First Slide">
				{
				  Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='padding-left:"+jcc_car_data[jcc_car].Slide.Padding+";padding-right:"+jcc_car_data[jcc_car].Slide.Padding+"' class='item active'>";
					...
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='text-align:"+jcc_car_data[jcc_car].Slide.Image_Placement+"'><img style='margin-top:"+jcc_car_data[0].slide_top_margin+"; width:"+jcc_car_data[1].Slide.image_size+"' src='"+img_loc+""+jcc_car_data[jcc_car].Slide.Image+"' x alt='"+jcc_car.toString()+"'></div>";
						}
					...
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='width: 75%; background-color:"+jcc_car_data[1].Slide.background_color+"; padding:"+jcc_car_data[jcc_car].Slide.Padding+"; text-align:"+jcc_car_data[0].Text_align+"; color:"+jcc_car_data[1].Slide.Text_Color+";'><Cr_body>"+jcc_car_data[jcc_car].Slide.Text+"</Cr_body></div>";					
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='margin-top: 20px; border-style:"+acc_ck.Border_Style+"; border-color:"+acc_ck.Border_Color+"; border-width:"+acc_ck.Border_Thickness+"; border-radius:"+acc_ck.Border_Radius+"; ' class='panel-group' id='jb_accordion_" + jcc + "'>";
...
jb_Acc_Con = "<div class='col-lg-12 col-md-12 col-xs-12' style='height: 100%; background-color:"+jcc_data[0].main_background_color+"; padding-bottom: 10px;;'>";												
