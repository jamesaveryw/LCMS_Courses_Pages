...
function returnLocale() {
	...
	switch (returnedLocale.locale) {
		case "ar-MA":
			returnedLocale.textTOC = "جدول المحتويات";
			break;

		case "en-US":
			returnedLocale.textTOC = "Table of Contents";
		...
		case "es-MX":
			returnedLocale.textTOC = "Tabla de contenido";
			break;

		case "fr-CA":
		case "fr-FR":
			returnedLocale.textTOC = "Table des matières";
		...
		case "id-ID":
			returnedLocale.textTOC = "Daftar Isi";
			break;

		case "ko-KR":
			returnedLocale.textTOC = "목차";
			break;

		case "pt-BR":
			returnedLocale.textTOC = "Índice";
			break;

		case "th-TH":
			returnedLocale.textTOC = "สารบัญ";
			break;

		case "vi-VN":
			returnedLocale.textTOC = "Mục lục";
			break;
		...
		case "zh-TW":
		case "zh-CHT":
			returnedLocale.textTOC = "目錄菜單"; //"目錄表";
			trans_button = "打開腳本";
			trans_close = "關閉腳本";
			submit_button = "提交"; //"發送";
		...
		case "zh-CN":
		case "zh-CHS":
			returnedLocale.textTOC = "目录菜单"; //"目录表";
			trans_button = "打开脚本";
			trans_close = "关闭脚本";
			submit_button = "提交"; //"发送";
					...
					switch (snglBld[jcc]) {
							...
							function card_setup(cdset) {
								...
								switch (cdset) {
									case 1:
										...
										if (flip_card_data[0].card_01_background_color.length === 0) { //radius   border-radius:
											//-----------------------------------------------<( 1 )>
									...
									case 2:
										...
										if (flip_card_data[0].card_02_background_color.length === 0) { //radius   border-radius:
											//-----------------------------------------------<( 1 )>
									...
									case 3:
										...
										if (flip_card_data[0].card_03_background_color.length === 0) { //radius   border-radius:
											//-----------------------------------------------<( 1 )>
						...
						case "Question_Comp":
							...
							if (qComp[0].image.length > 0) {
								//-------<( Added to check for portal or development )>-------
								if (typeof moduleFolder !== "undefined") { //src='jbuild_libs/images/
							...
							if (qComp[2].qList[0].qList_on_off === "on") {
								...
								for (var queList = 1; queList < list_num; queList++) { //margin-left:10px;
						...
						case "Divider":
							...
							var flipper;
							if (sSelections[jcc][snglBld[jcc]][3].flip === "false") {
								flipper = "0deg";
							}
							if (sSelections[jcc][snglBld[jcc]][3].flip === "true") {
								flipper = "180deg";
							}
						...
						case "image_w_text_old": //SA max-width:800px;
							...
							switch (sSelections[jcc][snglBld[jcc]][1].image_position) {
								...
								case "bottom": //align='sSelections[jcc][snglBld[jcc]][0].image_aligmnent'
									...
									if (screen.width > 540) { //jb_char_para
						...
						case "Learning_Objectives":
							...
							switch (locale.locale) {
								...
								case "es-MX":
									headlineText = "objetivo de estudios";
									headlineTextStyle = "style=\"color: #" + colorOption + "; font-family: 'Archivo';\"";
									break;

								case "fr-CA":
								case "fr-FR":
									headlineText = "Objectifs d'apprentissage";
									headlineTextStyle = "style=\"color: #" + colorOption + "; font-family: 'Archivo';\"";
									break;

								case "id-ID":
									headlineText = "Tujuan Pembelajaran";
									headlineTextStyle = "style=\"color: #" + colorOption + "; font-family: 'Archivo';\"";
									break;
								...
								case "pt-BR":
									headlineText = "objetivos de aprendizado";
									headlineTextStyle = "style=\"color: #" + colorOption + "; font-family: 'Archivo';\"";
									break;

								case "th-TH":
									headlineText = "เป้าหมายการเรียนรู้";
									headlineTextStyle = "style=\"color: #" + colorOption + "; font-family: 'Tahoma'; transform: translate(-50%, -84%);\"";
									break;

								case "vi-VN":
									headlineText = "Mục tiêu học tập";
									headlineTextStyle = "style=\"color: #" + colorOption + "; font-family: 'Tahoma'; transform: translate(-50%, -84%);\"";
									break;
									...
									case 1:
										...
										switch (String(Object.keys(sSelections[jcc][snglBld[jcc]][accm]))) {
											...
											case "image_w_text_old": //AC
												...
												switch (jcc_data[1].image_position) { // border-style:"+jcc_data[0].border_style+"; border-width:"+jcc_data[0].border_height+"; border-color:"+jcc_data[0].border_color+";
...
function Page_Selection(pgSel, loc) {
	...
	*/
	...
	//Get the information needed from the url...
	var bTemp = TOC_File_Order_Array[pgSel].split("_");
	console.log(TOC_File_Order_Array)
	console.log(pgSel);
	//console.log(bTemp);
	var bMod, bLsn, bPag;
	...
	switch (bTemp[4]) {
		case "TC.js":
			statementType = "Table of Contents";
			xapiPage = "TC";
			break;
		case "LO.js":
...
//acct
function imlt_zoom(c_cmp, acct, snpt) { // comp num, array in image
...
function mi_iwt_zoom(c_cmp, miwt_image, snpt) { // comp num, array in image
