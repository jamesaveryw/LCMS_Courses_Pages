...
/*
	<span class="keyterm" tabindex="0" role="button">random</span>
	<span class='keyterm'>Key Term</span>
...
//--------------------------------------------------											
//-------<(  Table_Builder_New Code Begin  )>-------
//--------------------------------------------------												
											
case "Table_Builder_New":
										new_tbl_id = "table_" + jcc;	
										var new_tbl_whole = sSelections[jcc][snglBld[jcc]];
										var row_number_count;
										var scbColor;	
//Table_Max_Height
											
			//alert(new_tbl_whole[2].Table_Settings[0].Table_Max_Height);								
		
		var tbl_width = new_tbl_whole[2].Table_Settings[0].Table_Width;									
		//alert("tbl_width: " + tbl_width);
		var new_left;
			...
			if(tbl_width === "100%")
			...
			else
				{
					...
					new_left = (100 - tbl_width.slice(0, -1));
					new_left = (new_left / 2);
				}
									...
									var tbl_outline;
											...
											if(new_tbl_whole[2].Table_Settings[0].Whole_Table_Border === "block")
												{
													tbl_outline = "solid";
												}
											else
												{
													tbl_outline = new_tbl_whole[2].Table_Settings[0].Whole_Table_Border;													
												}

									
											
										
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='col-lg-12 col-md-12 col-xs-12' align='center' style='margin-top:"+new_tbl_whole[2].Table_Settings[0].Top_Margin+";width:100%; padding:10px;overflow: auto; max-height:"+new_tbl_whole[2].Table_Settings[0].Table_Max_Height+"; border-style:"+tbl_outline+" ; border-width:"+new_tbl_whole[2].Table_Settings[0].Whole_Table_Thickness+"; border-color:"+new_tbl_whole[2].Table_Settings[0].Whole_Table_Color+";' >"; //border-style:solid; border-width: medium; border-color:black;		
											
Jcc_Comp_Maker = Jcc_Comp_Maker + "<table class='col-lg-12 col-md-12 col-xs-12' id='table_new"+jcc+"' style='width:"+tbl_width+"; margin-left:"+new_left+"%; margin-right:"+new_left+"%   ; border-collapse: collapse; padding:10px; text-align:center'>";
					//border:"+new_tbl_whole[2].Table_Settings[0].Whole_Table_Border+";	
				
											
					for(var tblhead = 0; tblhead < new_tbl_whole[0].Table_Heading.length; tblhead++) //Cell_Border_Color
						{

							var rmkr = new_tbl_whole[0].Table_Heading[tblhead].Heading_Col_Row_Maker;
							switch(new_tbl_whole[0].Table_Heading[tblhead].Heading_Col_Row_Maker)
							//switch(new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Border) 
								...
								if(rmkr === "LT")
									{
										tbl_border_array[0] = "border-left";
										tbl_border_array[1] = "border-top";
									}
										
								if(rmkr === "TR")
									{
										tbl_border_array[0] = "border-top";
										tbl_border_array[1] = "border-right";
									}
								...
								if(rmkr === "LB")
									{
										tbl_border_array[0] = "border-left";
										tbl_border_array[1] = "border-bottom";
									}
										
								if(rmkr === "BR")
									{
										tbl_border_array[0] = "border-bottom";
										tbl_border_array[1] = "border-right";
									}
								...
								if(rmkr === "TB")
									{
										...
										if(new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Color.length < 3)
											{
												scbColor = new_tbl_whole[0].Row_Color;
											}
										
										if(new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Color.length > 3)
											{
												scbColor = new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Color;
											}		
										
Jcc_Comp_Maker = Jcc_Comp_Maker + "<th style='"+tbl_border_array[0]+": "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Weight+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Border+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Color+";"+tbl_border_array[1]+": "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Weight+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Border+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Color+"; padding:10px; background-color:"+scbColor+"'>";	//new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Color														
											break;
/*	
					"+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Border+"       Heading_Single_Cell_Color
					"+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Weight+"
					"+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Color+"

					alert(new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Border);	
					alert(new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Weight);	
					alert(new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Color);								
*/										
						...
						// alert(new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Color);	
										...
										if(rmkr === "LTR")
											{
												tbl_border_array[0] = "border-left";
												tbl_border_array[1] = "border-top";
												tbl_border_array[2] = "border-right";
											}
										...
										if(rmkr === "TLB")
											{
												tbl_border_array[0] = "border-top";
												tbl_border_array[1] = "border-left";
												tbl_border_array[2] = "border-bottom";												
											}
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<th style='"+tbl_border_array[0]+": "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Weight+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Border+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Color+";"+tbl_border_array[1]+": "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Weight+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Border+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Color+" ; "+tbl_border_array[2]+": "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Weight+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Border+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Color+";  padding:10px; background-color:"+scbColor+"'>"; //new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Color
										
/*										
					"+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Border+"
					"+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Weight+"
					"+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Color+"										
*/										
										...
										//border-"+rmkr+"
Jcc_Comp_Maker = Jcc_Comp_Maker + "<th style='"+scLines+": "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Weight+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Border+" "+new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Border_Color+"; padding:10px; background-color:"+scbColor+"'>";	//new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Color									
											break;
										...
										//alert(new_tbl_whole[0].Table_Heading[tblhead].Heading_Single_Cell_Color.length);
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<th style='height:"+new_tbl_whole[0].Row_Height+";border: "+new_tbl_whole[0].Row_Whole_Weight+" "+new_tbl_whole[0].Row_Whole_Border+" "+new_tbl_whole[0].Row_Whole_Outline_Color+"; padding:10px; background-color:"+scbColor+"'>";

									
											break;
								}
							
				Jcc_Comp_Maker = Jcc_Comp_Maker + "<jb7 style=' color:"+new_tbl_whole[0].Table_Heading[tblhead].Heading_Text_Color+";font-style:"+new_tbl_whole[0].Table_Heading[tblhead].Heading_Text_Style+";font-weight:"+new_tbl_whole[0].Table_Heading[tblhead].Heading_Text_Weight+"'>"+new_tbl_whole[0].Table_Heading[tblhead].Heading_Text+"</jb7>";
				
				Jcc_Comp_Maker = Jcc_Comp_Maker + "</th>";
...
for(var rData_count = 0; rData_count < new_tbl_whole[1].Row_Column_Data.length; rData_count++)											
			{


Jcc_Comp_Maker = Jcc_Comp_Maker + "<tr>";				
				
				for(var tData = 0; tData < new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data.length; tData++)
						{

							//alert( new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Text );
							var dmker = new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Col_Row_Maker;
							switch(new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Col_Row_Maker)
								{
									...
									case "TRB":
										if(dmker === "LTR")
											{
												tbl_data_border_array[0] = "border-left";
												tbl_data_border_array[1] = "border-top";
												tbl_data_border_array[2] = "border-right";
											}
										
										if(dmker === "LBR")
											{
												tbl_data_border_array[0] = "border-left";
												tbl_data_border_array[1] = "border-bottom";
												tbl_data_border_array[2] = "border-right";
											}
										
										if(dmker === "TLB")
											{
												tbl_data_border_array[0] = "border-top";
												tbl_data_border_array[1] = "border-left";
												tbl_data_border_array[2] = "border-bottom";
											}
										
										if(dmker === "TRB")
											{
												tbl_data_border_array[0] = "border-top";
												tbl_data_border_array[1] = "border-right";
												tbl_data_border_array[2] = "border-bottom";
											}
								
					//Data_Cell_Text_Alignment_Single  new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Text
										
						//alert("Boom: " + new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Text_Alignment_Single );				
										
						tbl_whole_row_array[0] = new_tbl_whole[1].Row_Column_Data[rData_count].Row_Text_Alignment				
										
								//new_tbl_whole[1].Row_Column_Data[rData_count].Row_Text_Alignment
						////Data_Cell_Font	
										
		//alert("Data_Cell_Border: " + new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Color);   //  @@@@@@@@@@@@@@@@@@@@@@@								
										
Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='height:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Height+"; text-align:"+tbl_whole_row_array[0]+";"+tbl_data_border_array[0]+": "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Weight+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Color+"; "+tbl_data_border_array[1]+": "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Weight+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Color+"; "+tbl_data_border_array[2]+": "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Weight+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Color+"; background-color:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Color+"; padding:10px'>";										
									break;
									...
									case "TB":	
										...
										if(dmker === "BR")
											{
												tbl_data_border_array[0] = "border-bottom";
												tbl_data_border_array[1] = "border-right";
											}
										if(dmker === "TB")
											{
...
//alert("Data_Cell_Border: " + new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border);										
//alert("Data_Cell_Border_Color: " + new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Color )										
										
Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='height:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Height+"; text-align:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Text_Alignment+";"+tbl_data_border_array[0]+": "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Weight+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Color+"; "+tbl_data_border_array[1]+": "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Weight+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Color+"; background-color:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Color+"; padding:10px'>";										
									...
									case "block":
											...
											if(dmker === "block")
												...
												{
													dtLines = "border-" + dmker
												}	

//alert("Data_Cell_Border: " + new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border);										
//alert("Data_Cell_Border_Color: " + new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Color )											
//alert("Data_Cell_Border_Weight: " + new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Weight);										
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='height:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Height+"; text-align:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Text_Alignment+";"+dtLines+": "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Weight+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border+" "+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Color+"; background-color:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Color+"; padding:10px'>";						
									break;	
	...
	//alert( new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Color.length );	//	Data_Cell_Border_Color						
/*									
					"Data_Cell_Color":"",
					"Data_Cell_Border":"none",
					"Data_Cell_Col_Row_Maker":"none",  // none, block, left, top, right, bottom, LT, TR, LR, LB, BR, TB, LTR, LBR, TLB, TRB
					"Data_Cell_Border_Color":"", //#bf0d3f
					"Data_Cell_Border_Weight":"", //use px: Example 2px : 0px turns off the border completely										
*/		
										
							//alert(new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Color.length);			
							     
				//Data_Cell_Color						
										
				//Data_Cell_Border_Color						
										
				//Row_Outline	
										
//alert( new_tbl_whole[1].Row_Column_Data[rData_count].Row_Outline );
										
//alert( new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Color );										
										//Data_Cell_Border
			...
			if(new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Border_Weight.length === 0)							
	 				{
						tbl_single_row_data[3] = new_tbl_whole[1].Row_Column_Data[rData_count].Row_Outline_Weight
										...
										//background-color:"+tbl_single_row_data[1]+" ;
								 		//Data_Cell_Text_Alignment_Single  Row_Outline_Color
										
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='height:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Height+"; text-align:"+tbl_single_row_data[0]+";border: "+tbl_single_row_data[3]+" solid "+tbl_single_row_data[2]+";  background-color:"+tbl_single_row_data[1]+" ;padding:10px'>";	
									break;	
										
								} 
							
//alert(new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Font);
							
Jcc_Comp_Maker = Jcc_Comp_Maker + "<"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Font+" style='color:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Text_Color+";font-style:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Text_Style+";font-weight:"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Text_Weight+"'>"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Text+"</"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Font+"></td>";							
							
							//Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='border: 2px solid black; padding:10px'><jb7>"+new_tbl_whole[1].Row_Column_Data[rData_count].Row_Data[tData].Data_Cell_Text+"</jb7></td>";
						}
						...
						//Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='border: 2px solid black; padding:10px'>";
...
*/						
						...
						* /
						//Jcc_Comp_Maker = Jcc_Comp_Maker + "<jb7>"+new_tbl_whole[1].Row_Column_Data[0].Row_Data[tData].tbl_cell_text+"</jb7></td>";
...
//Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='background-color:"+new_tbl_whole[1].Row_Column_Data[cr_dec].Row_Data[rdl].Cell_Color+"; border: 4px solid green'>"
// Keep the below line untouched for reference. It works
											
//Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='background-color:"+new_tbl_whole[1].Row_Column_Data[cr_dec].Row_Data[rdl].Row_Single_Cell_Border+"; border-left: 4px solid green; border-top: 4px solid green; border-right: 4px solid green;'>"						
						
break;											

//----------------------------------------------											
//--------<(  Table_Builder_New Code End  )>--------  
//----------------------------------------------											
...
//alert(sSelections[jcc][snglBld[jcc]][tbl_num].Table_Heading_Padding);																	
						...
						Jcc_Comp_Maker = Jcc_Comp_Maker + "<th style='height:"+new_tbl[1].Table_Heading_Height+"'><"+new_tbl[0].tbl_column_font+">"+ sSelections[jcc][snglBld[jcc]][tbl_num].Table_Heading[thd].tbl_column +"</"+new_tbl[0].tbl_column_font+"></th>";	
						...
						Jcc_Comp_Maker = Jcc_Comp_Maker + "<th colspan='"+sSelections[jcc][snglBld[jcc]][tbl_num].Table_Heading[thd].colNumber+"'>"+ sSelections[jcc][snglBld[jcc]][tbl_num].Table_Heading[thd].tbl_column +"</th>";	
								...
								Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='background-color:"+tbl_top_data_color+"'>"+ sSelections[jcc][snglBld[jcc]][tbl_num].Row_Data[trw].tbl_column +"</td>";
																	...
																	if(tbl_top_data_color === "")
																		{
																			...
																			Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='color:"+column_text_color+" ;background-color:"+tbl_even_color+"'><"+new_tbl[0].tbl_column_font+">"+ sSelections[jcc][snglBld[jcc]][tbl_num].Row_Data[trw].tbl_column +"</"+new_tbl[0].tbl_column_font+"></td>";
																		}																		
																	break;
																	...
																	break;	
																			...
																			if(tbl_num % 2 === 1)
																				{
								Jcc_Comp_Maker = Jcc_Comp_Maker + "<td style='color:"+column_text_color+"; background-color:"+tbl_odd_color+"'><"+new_tbl[0].tbl_column_font+">"+ sSelections[jcc][snglBld[jcc]][tbl_num].Row_Data[trw].tbl_column +"</"+new_tbl[0].tbl_column_font+"></td>";
																				}
			...
			if(jcc_car === 1) // <img src="../Mod_01/images/boom.jpg" alt="First Slide">
				{
				  Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='padding-left:"+jcc_car_data[jcc_car].Slide.Padding+";padding-right:"+jcc_car_data[jcc_car].Slide.Padding+"' class='item active'>";
					...
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='text-align:"+jcc_car_data[jcc_car].Slide.Image_Placement+"'><img style='margin-top:"+jcc_car_data[0].slide_top_margin+"; width:"+jcc_car_data[jcc_car].Slide.image_size+"' src='"+img_loc+""+jcc_car_data[jcc_car].Slide.Image+"' x alt='"+jcc_car_data[jcc_car].Slide.Image_tag+"'></div>"; //jcc_car.toString()
					...
					if(typeof moduleFolder === "undefined")
						{
							pdf_logo = "../../../jbuild_libs/images/" + pdf_setup.Pdf_Icon; 
										...
										Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='col-lg-12 col-md-12 col-xs-12'>";	
											...
											Jcc_Comp_Maker = Jcc_Comp_Maker + "<img src='"+pdf_logo+"' width='50px' height='50px' style='cursor: pointer;' alt='' onclick='open_pdf_file("+jcc+")'>"; //pdf_setup.Pdf_File
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='jb_modal-content'>";	
Jcc_Comp_Maker = Jcc_Comp_Maker + "<p id='jb_modal_main_text' style='color: #ffffff;'></p>";	
Jcc_Comp_Maker = Jcc_Comp_Maker + "</div>";	
...
/*				
<div id='myModal' class='jb_modal'>       onclick='javascript:close_keyterm()'       

                                              jb_header_text
											  jb_modal_main_text

  <!-- Modal content -->
<div class='jb_modal-hdr-ftr'>Header</div>	
  <div class='jb_modal-content'>
	  
    
    <p style='color: #ffffff;'>Some text in the Modal..</p>
  </div>
<div class='jb_modal-hdr-ftr'><span class='jb_close'><button>Close</button></span></div> <!-- &times <span class="close">close</span>  -->
...
/*				
//================================================
//-------<(  Key Term Module Box Begin )>-------				
//================================================	

//-------<( Key Modal Box )>-------										
	Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='modal fade clickable btn btn-default' id='keyModal' role='dialog'><div class='modal-dialog'>";
	Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='modal-content'>";
//-------<>											
//Header
//-------<>												
	Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='modal-header' style='background-color:#0069aa'>"; //
	Jcc_Comp_Maker = Jcc_Comp_Maker + "<p id='key_term_head' class='modal-title' style='color:#ffffff; text_align:left; font-size:18px'></p>";
	Jcc_Comp_Maker = Jcc_Comp_Maker + "</div>";
//-------<>												
//Body
//-------<>
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='modal-body' style='background-color:#ffffff'>";

	Jcc_Comp_Maker = Jcc_Comp_Maker + "<p id='key_term_def' style='color:#000000;font-size:18px'></p>";				
...
//Footer
//-------<>												
	Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='modal-footer'>";
...
//document.getElementById("JcComponents").addEventListener("touchstart", progress_bar, false);
 ...
 //// var scrlht = ( (elmnt.scrollHeight) / (elmnt.scrollHeight - elmnt.offsetHeight)   );
  ...
  var nwht = (elmnt.scrollHeight - scrlht);	
	...
	for (var bCheck = 1; bCheck < document.getElementsByClassName("toc_fly_buttons").length; bCheck++){
		//console.log(document.getElementsByClassName("toc_fly_buttons")[bCheck].getElementsByTagName("span")[1].getElementsByTagName("img")[0].src);
...
function myFunction() {
  ...
  var height = document.documentElement.scrollHeight - document.documentElement.clientHeight;
	...
	//document.getElementById("Lesson_Title").innerHTML = $(window).width();
	 if($(window).width() < 768){scrolled = (winScroll / height) * 110;}  //window	JcComponents
	 
	 if($(window).width() >= 768){scrolled = (winScroll / height) * 102;} //window  JcComponents
	//JcComponents	
...
*/
/*function Page_Selection(pgSel,loc)  // Does this need to reside in the index page?
{
...
//-=--=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-
    ...
    var bPag = bTemp[4].substr(1,1);
    //console.log("Module number = " + bTemp[2].substr(1));
    //console.log("Lesson number = " + bTemp[3].substr(1));
    //console.log("Page number = " + bTemp[4].substr(1,1));
    ...
    switch (bTemp[4]){
        ...
        case "EOL.html": statementType = "End of Lesson Questions";
            xapiPage = "EOL";
            break;
        default: statementType = "Lesson Page";
            xapiPage = "P" + bPag;
    }
...
//if($("#card1").is(':visible') === true){alert("Card one is on");}
