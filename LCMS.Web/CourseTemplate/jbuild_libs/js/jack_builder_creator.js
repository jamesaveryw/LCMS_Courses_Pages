...
// Place this line after: onclick='alt_tag_lib("+ma_alt+")'> <img alt='Select image for more information' src='"+alt_icon+"' style='position:absolute; top:92%; left: 81%'>
			...
			Jcc_Comp_Maker = Jcc_Comp_Maker + "<div><button style='margin-top:10px;' class='btn btn-primary btn-sm' role='button' onclick='alt_tag_im_sa("+jcc+","+ma_alt+")'>Image Description</button></div>";			
				//-------<( Added by Jack on 11/30/2020. )>-------
			...
			*/
			...
			//-------<( Added by Jack on 12/01/2020. )>-------
						//Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='margin-top:10px'><button class='btn btn-primary btn-sm' role='button' onclick='alt_tag_lib("+jcc_car+","+jcc+")'>Image Description</button></div>";
							...
							Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='margin-top:10px'><button class='btn btn-primary btn-sm' role='button' onclick='alt_tag_lib("+jcc_car_alt+","+jcc_car+")'>Image Description</button></div>";
			//-------<( Added by Jack on 12/01/2020. )>-------
...
//-------<( Added by Jack on 11/30/2020. )>-------
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='margin-top:10px; margin-bottom:10px'><button class='btn btn-primary btn-sm' role='button' onclick='iwlt_alt_tag_lib("+jcc+")'>Image Description</button></div>";
//-------<( Added by Jack on 11/30/2020. )>-------							
						...
						imgwt_ac_whole[jcc] = ac_twmi;
							...
							if(jcc_data[0].image_w_text_tag.length > 125)
								...
								////	console.log("imgwt_ac_whole["+jcc+"]: " + imgwt_ac_whole[jcc]);
									...
									jb_Acc_Con = jb_Acc_Con + "<img style='border-style:"+jcc_data[0].border_style+"; border-width:"+jcc_data[0].border_height+"; border-color:"+jcc_data[0].border_color+"; border-radius:"+ jcc_data[8].image_radius +"' src='"+img_loc+"" + jcc_data[0].image_name + "' width=' " + jcc_data[2].image_size + " ' height='auto' alt='Select image for more information' role='button' onclick='imlt_zoom("+jcc+","+acc_Count+",101)'>";

								//-------<( Added by Jack on 11/30/2020. )>-------
									jb_Acc_Con = jb_Acc_Con + "<div style='margin-top:10px'><button class='btn btn-primary btn-sm' role='button' onclick='alt_tag_lib("+img_lst_ada+")'>Image Description</button></div>";
								//-------<( Added by Jack on 11/30/2020. )>-------	
							...
							if(jcc_data[0].image_w_text_tag.length > 125)
								{
									...
									jb_Acc_Con = jb_Acc_Con + "<img style='border-style:"+jcc_data[0].border_style+"; border-width:"+jcc_data[0].border_height+"; border-color:"+jcc_data[0].border_color+"; border-radius:"+ jcc_data[8].image_radius +"' src='"+img_loc+"" + jcc_data[0].image_name + "' width=' " + jcc_data[2].image_size + " ' height='auto' alt='' role='button' onclick='imlt_zoom("+jcc+","+acc_Count+",101)'>";
...
//-------<( Added by Jack on 12/15/2020. )>-------
jb_Acc_Con = jb_Acc_Con + "<div><button class='btn btn-primary btn-sm' role='button' onclick='alt_tag_im_ac("+jcc+","+acc_Count+")'>Image Description</button></div>";
//-------<( Added by Jack on 12/15/2020. )>-------
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div id='jbImgModal' class='img_modal' style='margin-top:36px'>";

Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='img_modal_hdr_ftr'><p id='jb_img_modal' style='color: #ffffff; text-align:left'></p></div>";	
									
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div class='img_modal_content' style='overflow-y:auto'>";	

Jcc_Comp_Maker = Jcc_Comp_Maker + "<img id='jb_modal_image' style='width:90%; height:90%; background-color:black' src='' x alt=''>";												
...
//		console.log(site_link);
		...
		switch(site_link)
			{
				case 1:
							window.open("https://www.loma.org/fraudshare/" , 'ext_window', 'fullscreen=true'); 
				break;
					
				case 2:
							window.open("https://www.loma.org/Solutions/FraudSource.aspx" , 'ext_window', 'fullscreen=true');
				break;
