...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='text-align:"+qComp[2].qList[0].align_text+"'><jb1>"+qComp[0].question+"</jb1></div><br>";                                        
