...
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='margin-top:"+jcc_flip_data[0].top_margin+"'><"+jcc_flip_data[0].Label_Font_Size+">"+jcc_flip_data[0].Label_Text+"</"+jcc_flip_data[0].Label_Font_Size+"></div>";
...
Jcc_Comp_Maker = Jcc_Comp_Maker + "</div>";											
Jcc_Comp_Maker = Jcc_Comp_Maker + "<br>";	
Jcc_Comp_Maker = Jcc_Comp_Maker + "<div><"+jcc_flip_data[0].Bottom_Text_Size+">"+jcc_flip_data[0].Bottom_Text+"</"+jcc_flip_data[0].Bottom_Text_Size+"></div>";											
			...
			if(jcc_car === 1) // <img src="../Mod_01/images/boom.jpg" alt="First Slide">
				{
				  Jcc_Comp_Maker = Jcc_Comp_Maker + "<div style='padding-left:"+jcc_car_data[jcc_car].Slide.Padding+";padding-right:"+jcc_car_data[jcc_car].Slide.Padding+"' class='item active'>";
					...
					if(jcc_car_data[jcc_car].Slide.Image.length > 0)
						{
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<img style='margin-top:"+jcc_car_data[0].slide_top_margin+"; width:"+jcc_car_data[1].Slide.image_size+"' src='"+img_loc+""+jcc_car_data[jcc_car].Slide.Image+"' x alt='"+jcc_car.toString()+"'>";
						}
					
					Jcc_Comp_Maker = Jcc_Comp_Maker + "<p style='background-color:"+jcc_car_data[1].Slide.background_color+"; padding:"+jcc_car_data[jcc_car].Slide.Padding+"; text-align:"+jcc_car_data[0].Text_align+"; color:"+jcc_car_data[1].Slide.Text_Color+"; font-size:"+jcc_car_data[1].Slide.Text_Font_Size+"'>"+jcc_car_data[jcc_car].Slide.Text+"</p>";					
...
jb_Acc_Con = jb_Acc_Con + "<div style='background-color: " + jcc_data[7].background_color + "'>";								
		...
		switch(jcc_data[1].image_position)
			{ // border-style:"+jcc_data[0].border_style+"; border-width:"+jcc_data[0].border_height+"; border-color:"+jcc_data[0].border_color+";
				...
				case "left":
					jb_Acc_Con = jb_Acc_Con + "<div style='text-align:"+jcc_data[1].image_position+"'><table class='jc_table'><tr><td><img style='border-style:"+jcc_data[0].border_style+"; border-width:"+jcc_data[0].border_height+"; border-color:"+jcc_data[0].border_color+"; border-radius:"+ jcc_data[8].image_radius +"' src='"+img_loc+"" + jcc_data[0].image_name + "' width=' " + jcc_data[2].image_size + " ' height='auto' alt=''/></td><td style='width:10px'></td><td style='color:"+jcc_data[4].image_text_color+"; text-align: "+ jcc_data[5].image_text_alignmnet +";'>"+jcc_data[3].image_text+"</td></tr></table></div>";					
				break;
					
				case "right":
					jb_Acc_Con = jb_Acc_Con + "<div style='text-align:"+jcc_data[1].image_position+"'><table class='jc_table'><tr><td style='color:"+jcc_data[4].image_text_color+"; text-align: "+ jcc_data[5].image_text_alignmnet +";'>"+jcc_data[3].image_text+"</td><td style='width:10px'></td><td><img style='border-style:"+jcc_data[0].border_style+"; border-width:"+jcc_data[0].border_height+"; border-color:"+jcc_data[0].border_color+"; border-radius:"+ jcc_data[8].image_radius +"' src='"+img_loc+"" + jcc_data[0].image_name + "' width=' " + jcc_data[2].image_size + " ' height='auto' alt=''/></td></tr></table></div>";					
				break;				
			}
